...
!function (t, e) {
  ...
  return function (t) {
    ...
    function r(t, e) {
      ...
      if ("object" == _typeof(t) && !_instanceof(t, Date)) {
        var o = {};
    ...
    e.deconstructPacket = function (t) {
      ...
      function n(t, a, p) {
        ...
        if (c && _instanceof(t, Blob) || u && _instanceof(t, File)) {
          r++;
    ...
    function n(t) {
      return r && Buffer.isBuffer(t) || o && (_instanceof(t, ArrayBuffer) || i(t));
    }
    ...
    function r(t, e) {
      if (!_instanceof(this, r)) return new r(t, e);
    ...
    e.encodePacket = function (t, e, n, i) {
      ...
      if ("undefined" != typeof ArrayBuffer && _instanceof(a, ArrayBuffer)) return o(t, e, i);
      if ("undefined" != typeof w && _instanceof(a, w)) return s(t, e, i);
      ...
      if ("undefined" != typeof w && _instanceof(t.data, w)) {
        var o = new FileReader();
        return o.onload = function () {
      ...
      function r(t, n) {
        e.encodePacket(t, !0, !0, function (t) {
          ...
          for (var i = _instanceof(t, ArrayBuffer) ? t.byteLength : t.size, s = i.toString(), a = new Uint8Array(s.length + 1), o = 0; o < s.length; o++) {
            a[o] = parseInt(s[o]);
          }
    ...
    function r(t) {
      ...
      if ("function" == typeof Buffer && Buffer.isBuffer && Buffer.isBuffer(t) || "function" == typeof ArrayBuffer && _instanceof(t, ArrayBuffer) || s && _instanceof(t, Blob) || a && _instanceof(t, File)) return !0;
